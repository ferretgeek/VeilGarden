# Veil Garden project rules

- Read the workspace root `README.md` and this file before changing the project.
- Preserve the product boundary: Veil Garden organizes user-provided records only. Never add Apple password, 2FA, cookie, session, trust-token, private API, scraping, browser automation, or automatic address creation flows.
